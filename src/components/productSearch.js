...
const ProductSearch = () => {
    ...
    return (
        <div className="position-relative h-100">
            <input className="form-control h-100" placeholder="Ən az 3 simvol daxil edib axtarış edin" ref={inputBox} value={searchParam} onChange={e => handleSearch(e.target.value)}/>
