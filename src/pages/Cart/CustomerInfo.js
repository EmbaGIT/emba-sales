...
const CustomerInfo = () => {
  ...
  const searchOnDatabase = () => {
    if (
      (customerInfo.name.length && customerInfo.surname.length) ||
      customerInfo.finCode ||
      customerInfo.identifierNumber
    ) {
      getAvailableCustomer({
        variables: {
          name: `${customerInfo.surname} ${customerInfo.name}`,
          serial: customerInfo.identifierNumber
            ? customerInfo.identifierNumber
            : null,
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="row mb-3">
          <div className="col-md-6">
            <label>
              Sifariş tarixi<span className="text-danger">*</span>
            </label>
            <DatePicker
              className="form-control"
              selected={orderDate}
